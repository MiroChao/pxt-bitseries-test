...
namespace BitTest {
    export class dosomthing {
        ...
        select_grove_port(isRead: boolean) {
            if (isRead == true) {
                if (this.grove == GrovePort.P0) {
                    this.Din_stat = pins.digitalReadPin(DigitalPin.P0);
                } else if (this.grove == GrovePort.P1) {
                    this.Din_stat = pins.digitalReadPin(DigitalPin.P1);
                } else if (this.grove == GrovePort.P2) {
                    this.Din_stat = pins.digitalReadPin(DigitalPin.P2);
                } else if (this.grove == GrovePort.P8) {
                    this.Din_stat = pins.digitalReadPin(DigitalPin.P8);
                } else if (this.grove == GrovePort.P16) {
                    this.Din_stat = pins.digitalReadPin(DigitalPin.P16);
                }
                ...
                if (this.grove == GrovePort.P0) {
                    pins.digitalWritePin(DigitalPin.P0, this.Dout_stat);
                } else if (this.grove == GrovePort.P1) {
                    pins.digitalWritePin(DigitalPin.P1, this.Dout_stat);
                } else if (this.grove == GrovePort.P2) {
                    pins.digitalWritePin(DigitalPin.P2, this.Dout_stat);
                } else if (this.grove == GrovePort.P8) {
                    pins.digitalWritePin(DigitalPin.P8, this.Dout_stat);
                } else if (this.grove == GrovePort.P16) {
                    pins.digitalWritePin(DigitalPin.P16, this.Dout_stat);
                }
            }
        }
        ...
        select_analog_port(isRead: boolean) {
            if (isRead == true) {
                ...
                if (this.analogIO == AnalogPort.P0) {
                    pins.analogWritePin(AnalogPin.P0, this.Aout_value);
                } else if (this.analogIO == AnalogPort.P1) {
                    pins.analogWritePin(AnalogPin.P1, this.Aout_value);
                } else if (this.analogIO == AnalogPort.P2) {
                    pins.analogWritePin(AnalogPin.P2, this.Aout_value);
                }
            }
        }
        ...
        */
        ...
        //% Din.fieldOptions.columns=3
        //% group="Digital"
        read_Din_value(Din: GrovePort): number {
            let Din_stat: number;
            if (Din == GrovePort.P0) {
